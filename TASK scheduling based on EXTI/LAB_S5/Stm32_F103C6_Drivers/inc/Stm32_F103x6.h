...
//-*-*-*-*-*-*-*-*-*-*-*-
//Peripheral register: General-purpose timers (TIM2 to TIM5)
//-*-*-*-*-*-*-*-*-*-*-*
...
}General_purpose_TIM2_5_TypeDef;
...
typedef struct
{
	...
	volatile uint32_t AFIO_MAPR2; //0c1c
...
#define TIM2				   ((General_purpose_TIM2_5_TypeDef *)TIM2_BASE)
#define TIM3				   ((General_purpose_TIM2_5_TypeDef *)TIM3_BASE)
#define TIM4				   ((General_purpose_TIM2_5_TypeDef *)TIM4_BASE)
#define TIM5				   ((General_purpose_TIM2_5_TypeDef *)TIM5_BASE)
...
#define NVIC_IRQ38_USART2_Disable        (NVIC_ICER2 |= 1<<(USART2_IRQ-32))
#define NVIC_IRQ39_USART3_Disable        (NVIC_ICER3 |= 1<<(USART3_IRQ-32))
...
//I2C Enable Macros:
#define NVIC_IRQ31_I2C1_EV_Enable 		 (NVIC_ISER0 |= 1<<(I2C1_EV))
#define NVIC_IRQ32_I2C1_ER_Enable        (NVIC_ISER1 |= 1<<(I2C1_ER-32))
#define NVIC_IRQ33_I2C2_EV_Enable 	     (NVIC_ISER1 |= 1<<(I2C2_EV-32))
#define NVIC_IRQ34_I2C2_ER_Enable        (NVIC_ISER1 |= 1<<(I2C2_ER-32))

//I2C Disable Macros:
#define NVIC_IRQ31_I2C1_EV_Disable       (NVIC_ICER0 |= 1<<(I2C1_EV))
#define NVIC_IRQ32_I2C1_ER_Disable       (NVIC_ICER1 |= 1<<(I2C1_ER-32))
#define NVIC_IRQ33_I2C2_EV_Disable       (NVIC_ICER1 |= 1<<(I2C2_EV-32))
#define NVIC_IRQ34_I2C2_ER_Disable       (NVIC_ICER1 |= 1<<(I2C2_ER-32))
